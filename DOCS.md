...
### 2024-06-13
- Исправлено: при формировании вопросов из базы теперь учитывается реальное значение поля source (db или ai), чтобы корректно отображать источник вопроса пользователю (раньше всегда подставлялся 'db').