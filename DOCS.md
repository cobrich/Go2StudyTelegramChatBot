...
- **Commit 8 (2025-07-10):** Исправлена критическая ошибка  в , которая возникала из-за вызова удаленного метода . Вызов был заменен на актуальный метод , что восстановило функциональность генерации AI-вопросов.


- **Commit 9 (2025-07-10):** Внедрен механизм повторных попыток с экспоненциальной задержкой в  для обработки ошибок . Это повышает надежность генерации вопросов, позволяя системе автоматически восстанавливаться после временных ограничений API.


- **Commit 10 (2025-07-10):** Улучшен парсер ответов AI в . Добавлена очистка поля  от случайных символов (например, , ), что повышает устойчивость к ошибкам форматирования и увеличивает количество успешно разобранных вопросов.
