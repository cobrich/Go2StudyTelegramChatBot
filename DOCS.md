...
- Создает **10 русских разделов + 38 подтем** с `language='ru'`
- Создает **10 казахских разделов + 36 подтем** с `language='kk'`
...
#### 📊 Результат:
- **При первом запуске**: автоматически создается **20 разделов и 74 подтемы**
...
```python
TOPIC_HIERARCHY = {
    "📊 Арифметика и числа": [6 подтем],
    "🔢 Операции с числами": [4 подтемы], 
    "🍰 Дроби": [4 подтемы],
    "💯 Проценты": [3 подтемы],
    "🔤 Уравнения и выражения": [3 подтемы],
    "🧠 Логика и закономерности": [3 подтемы],
    "📐 Геометрия": [4 подтемы],
    "📏 Единицы измерения": [4 подтемы],
    "📈 Работа с данными": [2 подтемы],
    "🎯 Практические задачи": [3 подтемы]
}
```
...
```python
TOPIC_HIERARCHY_KK = {
    "📊 Арифметика және сандар": [6 подтем],
    "🔢 Сандармен амалдар": [4 подтемы],
    "🍰 Бөлшектер": [6 подтем],
    "💯 Пайыздар": [3 подтемы],
    "🔤 Теңдеулер мен өрнектер": [4 подтемы],
    "🧠 Логика және заңдылықтар": [3 подтемы],
    "📐 Геометрия": [5 подтем],
    "📏 Өлшем бірліктері": [4 подтемы],
    "📈 Деректермен жұмыс": [2 подтемы],
    "🎯 Практикалық есептер": [3 подтемы]
}
```
...
- 🇷🇺 **10 русских разделов + 38 подтем**
- 🇰🇿 **10 казахских разделов + 36 подтем**
- **Всего: 20 разделов и 74 подтемы**