...
- **Усилен промпт для AI:** В промпт добавлены более строгие инструкции, запрещающие AI многократно использовать одни и те же сценарии и персонажей (например, "задачи про трех подруг"), что способствует увеличению разнообразия генерируемых вопросов.
