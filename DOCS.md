...
**Применяется к:**
- ✅ Сообщения во время выбора темы (3 сек)
- ✅ Сообщения во время активного теста (4 сек)
- ✅ Неизвестные команды (3 сек)
- ✅ Недоступные команды для учеников (4 сек)
...
- 🚫 "📚 Выбрать тему и начать" - если уже в тесте
