...
- Сопровождается ОЧЕНЬ ПОДРОБНЫМ объяснением для детей

ЭТАП 4: СОЗДАЙ ОБЪЯСНЕНИЕ ДЛЯ РЕБЕНКА
Объяснение должно быть написано так, как будто ты объясняешь своему младшему брату:
- ПРОСТЫЕ СЛОВА (не "определим", а "найдем")
- ПОШАГОВОЕ решение (Шаг 1, Шаг 2, ...)
- ПОКАЗАТЬ ВСЕ ВЫЧИСЛЕНИЯ ("умножаем 5 на 3, получается 15")
- ОБЪЯСНИТЬ ПОЧЕМУ делаем каждое действие
- ПРОВЕРКА в конце ("Давайте проверим наш ответ...")
- Использовать слова: "сначала", "потом", "получается", "проверим"

ЭТАП 5: ПРОВЕРЬ КАЧЕСТВО
...
- Объяснение понятно ребенку 10-12 лет
- В объяснении есть пошаговое решение
- Показаны все вычисления
- Есть проверка ответа
