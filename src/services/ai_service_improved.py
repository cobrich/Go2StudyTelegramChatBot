...
5.  **ТЫЙЫМ САЛЫНАДЫ:** "Үш дос/құрбы..." сияқты шаблондарды бірнеше рет қатарынан қолдануға қатаң тыйым салынады. Шығармашылықпен ойланыңыз!
...
5.  **ЗАПРЕЩЕНО:** Категорически запрещено использовать шаблон "Три подруги/друга..." в нескольких ответах подряд. Прояви воображение!
