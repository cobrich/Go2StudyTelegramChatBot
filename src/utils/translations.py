...
MESSAGES_RU = {
    ...
    'in_topic_selection_help': "📚 Вы находитесь в процессе выбора темы!\n\n🔹 Выберите раздел математики из кнопок выше\n🔹 Или нажмите '🏠 В главное меню' чтобы вернуться\n\n💡 Другие действия сейчас недоступны. Сначала выберите тему или вернитесь в главное меню.",
    
    'in_active_test_help': "📝 Вы сейчас проходите тест!\n\n🔹 Отвечайте на вопросы, используя кнопки с вариантами ответов\n🔹 Для навигации используйте кнопки '⬅️ Предыдущий' и '➡️ Следующий'\n🔹 Чтобы вернуться к выбору тем, нажмите '📚 Выбрать другую тему' на первом вопросе\n\n💡 Текстовые сообщения во время теста не обрабатываются.",
