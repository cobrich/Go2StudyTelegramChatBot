...
MESSAGES_RU = {
    ...
    'preparing_questions': "🔍 Пожалуйста, подождите несколько секунд. Подготавливаем вопросы...",
    'preparing_random_test': "🎯 Пожалуйста, подождите несколько секунд. Подготавливаю случайный тест из 10 вопросов...",
    'preparing_retry_test': "🎯 Пожалуйста, подождите несколько секунд. Подготавливаю тест на основе ваших ошибок...",
    ...
    'topic_not_selected': "❓ Я не понял ваше сообщение.\n\n🔹 Пожалуйста, используйте кнопки меню\n🔹 Или введите команду /start для перезапуска",
    
    'no_test_results': "У вас пока нет результатов тестов.",
    'progress_title': "📊 **Ваш прогресс:**\n\n",
    
    'in_topic_selection_help': "📚 Выберите тему из кнопок выше!\n\n🔹 Нажмите на любую тему математики\n🔹 Или нажмите '🏠 В главное меню'\n\n💡 Пока не выберете тему, другие сообщения не работают.",
    
    'in_active_test_help': "📝 Вы проходите тест!\n\n🔹 Отвечайте кнопками с вариантами ответов\n🔹 Используйте '⬅️ Назад' и '➡️ Далее'\n🔹 Чтобы выйти из теста, нажмите '📚 Выбрать другую тему'\n\n💡 Текстовые сообщения во время теста не работают.",
